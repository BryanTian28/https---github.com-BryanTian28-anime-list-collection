...
//before
{
  ...
  <h1 css={logoStyles}>Zoro.to</h1>
  <ul css={navListStyles}>
    <li css={navItemStyles}>Home</li>
    <li css={navItemStyles}>About</li>
    <li css={navItemStyles}>Contact</li>
    <li css={navItemStyles}>Anime</li>
    <li css={navItemStyles}>Manga</li>
  </ul>
</nav>;

const navbarStyles: SerializedStyles = css`
  display: flex;
  flex-direction: row;
  align-items: center;
...
const navListStyles: SerializedStyles = css`
  display: flex;
  flex-direction: row;
  justify-content: space-around;
`;
